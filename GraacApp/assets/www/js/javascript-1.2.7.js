...
function deleteCB() {
	navigator.notification.alert('Excluído com sucesso');
}
...
function campoObrigatorio() {
	navigator.notification.alert('Favor preencher todos os campos obrigat�rios');
}
...
function cadastrarUsuario() {
	// window.openDatabase(nome, versão, nome de exibição, tamanho);
	var db = window.openDatabase("Teste", "1.0", "Phonegap DB", 1000000);
	db.transaction(cadastrarUsuarioDB);
}
// Função de login TELA INDEX
// =======================
